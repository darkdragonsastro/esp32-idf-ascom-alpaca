...
private:
  ...
  static esp_err_t handle_get_telescope_alignmentmode(httpd_req_t *req);
  static esp_err_t handle_get_telescope_altitude(httpd_req_t *req);
  static esp_err_t handle_get_telescope_aperturearea(httpd_req_t *req);
  static esp_err_t handle_get_telescope_aperturediameter(httpd_req_t *req);
  static esp_err_t handle_get_telescope_athome(httpd_req_t *req);
  static esp_err_t handle_get_telescope_atpark(httpd_req_t *req);
  static esp_err_t handle_get_telescope_azimuth(httpd_req_t *req);
  static esp_err_t handle_get_telescope_canfindhome(httpd_req_t *req);
  static esp_err_t handle_get_telescope_canpark(httpd_req_t *req);
  static esp_err_t handle_get_telescope_canpulseguide(httpd_req_t *req);
  static esp_err_t handle_get_telescope_cansetdeclinationrate(httpd_req_t *req);
  static esp_err_t handle_get_telescope_cansetguiderates(httpd_req_t *req);
  static esp_err_t handle_get_telescope_cansetpark(httpd_req_t *req);
  static esp_err_t handle_get_telescope_cansetpierside(httpd_req_t *req);
  static esp_err_t handle_get_telescope_cansetrightascensionrate(httpd_req_t *req);
  static esp_err_t handle_get_telescope_cansettracking(httpd_req_t *req);
  static esp_err_t handle_get_telescope_canslew(httpd_req_t *req);
  static esp_err_t handle_get_telescope_canslewaltaz(httpd_req_t *req);
  static esp_err_t handle_get_telescope_canslewaltazasync(httpd_req_t *req);
  static esp_err_t handle_get_telescope_canslewasync(httpd_req_t *req);
  static esp_err_t handle_get_telescope_cansync(httpd_req_t *req);
  static esp_err_t handle_get_telescope_cansyncaltaz(httpd_req_t *req);
  static esp_err_t handle_get_telescope_canunpark(httpd_req_t *req);
  static esp_err_t handle_get_telescope_declination(httpd_req_t *req);
  static esp_err_t handle_get_telescope_declinationrate(httpd_req_t *req);
  static esp_err_t handle_put_telescope_declinationrate(httpd_req_t *req);
  static esp_err_t handle_get_telescope_doesrefraction(httpd_req_t *req);
  static esp_err_t handle_put_telescope_doesrefraction(httpd_req_t *req);
  static esp_err_t handle_get_telescope_equatorialsystem(httpd_req_t *req);
  static esp_err_t handle_get_telescope_focallength(httpd_req_t *req);
  static esp_err_t handle_get_telescope_guideratedeclination(httpd_req_t *req);
  static esp_err_t handle_put_telescope_guideratedeclination(httpd_req_t *req);
  static esp_err_t handle_get_telescope_guideraterightascension(httpd_req_t *req);
  static esp_err_t handle_put_telescope_guideraterightascension(httpd_req_t *req);
  static esp_err_t handle_get_telescope_ispulseguiding(httpd_req_t *req);
  static esp_err_t handle_get_telescope_rightascension(httpd_req_t *req);
  static esp_err_t handle_get_telescope_rightascensionrate(httpd_req_t *req);
  static esp_err_t handle_put_telescope_rightascensionrate(httpd_req_t *req);
  static esp_err_t handle_get_telescope_sideofpier(httpd_req_t *req);
  static esp_err_t handle_put_telescope_sideofpier(httpd_req_t *req);
  static esp_err_t handle_get_telescope_siderealtime(httpd_req_t *req);
  static esp_err_t handle_get_telescope_siteelevation(httpd_req_t *req);
  static esp_err_t handle_put_telescope_siteelevation(httpd_req_t *req);
  static esp_err_t handle_get_telescope_sitelatitude(httpd_req_t *req);
  static esp_err_t handle_put_telescope_sitelatitude(httpd_req_t *req);
  static esp_err_t handle_get_telescope_sitelongitude(httpd_req_t *req);
  static esp_err_t handle_put_telescope_sitelongitude(httpd_req_t *req);
  static esp_err_t handle_get_telescope_slewing(httpd_req_t *req);
  static esp_err_t handle_get_telescope_slewsettletime(httpd_req_t *req);
  static esp_err_t handle_put_telescope_slewsettletime(httpd_req_t *req);
  static esp_err_t handle_get_telescope_targetdeclination(httpd_req_t *req);
  static esp_err_t handle_put_telescope_targetdeclination(httpd_req_t *req);
  static esp_err_t handle_get_telescope_targetrightascension(httpd_req_t *req);
  static esp_err_t handle_put_telescope_targetrightascension(httpd_req_t *req);
  static esp_err_t handle_get_telescope_tracking(httpd_req_t *req);
  static esp_err_t handle_put_telescope_tracking(httpd_req_t *req);
  static esp_err_t handle_get_telescope_trackingrate(httpd_req_t *req);
  static esp_err_t handle_put_telescope_trackingrate(httpd_req_t *req);
  static esp_err_t handle_get_telescope_trackingrates(httpd_req_t *req);
  static esp_err_t handle_get_telescope_utcdate(httpd_req_t *req);
  static esp_err_t handle_put_telescope_utcdate(httpd_req_t *req);
  static esp_err_t handle_put_telescope_abortslew(httpd_req_t *req);
  static esp_err_t handle_get_telescope_axisrates(httpd_req_t *req);
  static esp_err_t handle_get_telescope_canmoveaxis(httpd_req_t *req);
  static esp_err_t handle_get_telescope_destinationsideofpier(httpd_req_t *req);
  static esp_err_t handle_put_telescope_findhome(httpd_req_t *req);
  static esp_err_t handle_put_telescope_moveaxis(httpd_req_t *req);
  static esp_err_t handle_put_telescope_park(httpd_req_t *req);
  static esp_err_t handle_put_telescope_pulseguide(httpd_req_t *req);
  static esp_err_t handle_put_telescope_setpark(httpd_req_t *req);
  static esp_err_t handle_put_telescope_slewtoaltazasync(httpd_req_t *req);
  static esp_err_t handle_put_telescope_slewtocoordinatesasync(httpd_req_t *req);
  static esp_err_t handle_put_telescope_slewtotargetasync(httpd_req_t *req);
  static esp_err_t handle_put_telescope_synctoaltaz(httpd_req_t *req);
  static esp_err_t handle_put_telescope_synctocoordinates(httpd_req_t *req);
  static esp_err_t handle_put_telescope_synctotarget(httpd_req_t *req);
  static esp_err_t handle_put_telescope_unpark(httpd_req_t *req);
